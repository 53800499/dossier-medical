'use strict'; $(document).ready(function () {
    ...
    if ($('#radial-chart').length > 0) {
        var radialChart = { chart: { height: 150, type: 'radialBar', toolbar: { show: false, } }, plotOptions: { radialBar: { dataLabels: { name: { fontSize: '22px', }, value: { fontSize: '16px', }, total: { show: true, label: 'Total', formatter: function (w) { return 249 } } } } }, series: [44, 55, 67], labels: ['Apples', 'Oranges', 'Bananas', 'Berries'], }
